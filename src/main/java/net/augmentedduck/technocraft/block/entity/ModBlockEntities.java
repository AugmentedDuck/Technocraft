...
public class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<RTGBlockEntity>> RTG_BE = BLOCK_ENTITIES.register("rtg_be", () -> BlockEntityType.Builder.of(RTGBlockEntity::new, ModBlocks.RTG_BLOCK.get()).build(null));
